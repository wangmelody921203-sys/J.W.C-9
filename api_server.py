...
def _call_gemini_chat(*, messages: list[dict], max_tokens: int = 1200, temperature: float = 0.65) -> tuple[str, str]:
...
def _call_groq_chat_with_fallback(client, *, messages: list[dict], max_tokens: int = 1200, temperature: float = 0.7, timeout: float = 12.0) -> tuple[str, str]:
